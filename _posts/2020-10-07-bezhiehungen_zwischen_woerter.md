...
「ありの巣には、いくつもの部屋があります」
提示されている回答例は次のようになっています。

![](/assets/2020/10/beziehungen_zwischen_woerter/answer.png)
...
子供と一緒に本を読む場合は私が知らない単語や言い回しを補足するのに加えて、
...
例文: Im Ameisenest gibt es viele Zimmer.
...
ドイツ語だと「ありの巣」は "Ameise"（あり）と "Nest"（巣）の合成語 "Ameisennest" にしていますが、
《von + 与格》を使って "das Nest von Ameisen" でも意味的には通じます。
