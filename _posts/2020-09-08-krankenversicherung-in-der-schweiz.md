...
保険料（月） | 416.85 SFr | 48,500円


健康でまったく病院にいかない場合でも、
保険料として年間 3563.4 SFr (414,000円）を支払う必要があります。

一方で持病があり免責額・自己負担額を上回る治療費の支払いがある場合、
保険料として年間 5002.2 SFr (582,000円）、
免責額として 300 SFr（35,000円）、
自己負担額として 700 SFr（81,000円）の合計 6302.2 SFr (698,000円）を支払うことになります。

事例 | 保険料 | 免責額 | 自己負担額 | 合計
- | - | -: | -: | -: | -:
ケース1 | 3'563.4 SFr | 0 SFr | 0 SFr | 3'563.4 SFr
ケース2 | 5'002.2 SFr | 300 SFR | 700 SFr | 6'002.2 SFr
...
基本保険と追加保険は同じ保険会社から購入しても、
別の保険会社から購入しても構いません。
ただし同一保険会社から購入した方が保険金請求手続きなどは簡単になります。

### 入院

入院に関する追加保険はリスクに対応するというより、
より良い治療を受け、
快適な入院生活を送るためのものです。
...
このような病院では、
該当するレベルの追加保険に加入していることが入院の前提条件となります。
...
通常は病院が医師を割り当てますが、
二人部屋プランならびに個室プランでは患者が医師を指名することが可能です。
...
基本保険から支払われるのは5割かつ年間 500 SFr に限られますが、
その搬送費用をカバーすることができます。
